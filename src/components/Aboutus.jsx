      ...
      <div className="overflow-hidden">
        <div className="m-6 h-screen w-[1450px] mt-[310px] md:mt-[0px]">
          <div className="grid grid-cols-1 h-screen w-full md:grid-cols-2">
            <div className="flex flex-col h-[500px] w-[300px] ml-20 md:w-[650px]">
            ...
            <div className="flex flex-col mt-[200px] ml-[250px] h-[600px] w-[300px] text-xl md:w-[600px] md:mt-[0px]">
              ...
              <button className="h-[100px] w-[170px] rounded-lg shadow-xl bg-yellow-500 mt-16 mb-12">Read More</button>
            </div>
